                            ...
                            <div class="row">
                                <div class="form-inline mb-3 col-md-9">
                                 ...
                                 <div class="mb-3 col-md-9">
                                    ...
                                    <textarea class=" p-2 form-control border" placeholder="Leave a description here" style="resize: none" name="description" id="" rows="10">{{ old('description', $expense->description) }}</textarea>
                                    @error('description')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                 </div>
                                <div class="mb-3 col-md-9">
                                    ...
                                    <input type="number" placeholder="eg.1000000" name="amount_spent"
                                        class="form-control border border-2 p-2" value='{{ old('check_out_date', $expense->amount_spent) }}'>
                                    @error('amount_spent')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror
                                </div>
                                <div class="mb-3 col-md-9">
                                    ...
                                    <input type="date" name="date_of_expenditure"
                                        ...
                                        value='{{ old('check_out_date', $expense->date_of_expenditure) }}'>
